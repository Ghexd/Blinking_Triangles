...
// Convert Hex color from Lively to RGB object
...
function livelyPropertyListener(name, val)
{
  switch(name) {
    case "mainColor":
      ...
      if(color) {
          CONFIG.baseColor = { r: color.r, g: color.g, b: color.b };
          generateMesh(); 
      }
      break;
    ...
    case "blinkColor":
      var color = hexToRgb(val);
      if(color) {
          CONFIG.brightColor = { r: color.r, g: color.g, b: color.b };
      }
      break;   
      
    case "trianglesNumber":
      CONFIG.triangleCount = val;
      generateMesh();
      break;     
  }
}
